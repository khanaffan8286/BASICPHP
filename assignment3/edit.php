...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
  ...
  <div class="bg-white p-8 m-4 rounded-2xl shadow-md w-full max-w-md">
    <h2 class="text-2xl font-bold mb-6 text-center">Update Your Information</h2>
    <form class="space-y-4" action="/MYFIRSTPHP/assignment3/process.php" id="form" method="POST">
      <div>
  ...
  class="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo htmlspecialchars($Address); ?></textarea>
      ...
      <div>
        ...
        <div class="relative">
          <input type="Password" id="ConfirmPassword" name="ConfirmPassword"  value="<?php echo trim($ConfirmPassword);?>"
            class="mt-1 w-full px-4 py-2 pr-10 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
  ...
  class="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
               <span id="doberror" class="text-sm text-center font-medium text-red-600"></span>
      </div>
      ...
      <div>
        ...
        <input type="number" id="age" name="age" readonly  value="<?php echo $Age?>"
               class="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
      ...
      <div>
        ...
        <input type="number" id="zip"  name="zip"  value="<?php echo $Zipcode?>"
               class="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
      ...
      <div>
        ...
        <input type="number" id="mobile"  name="mobile"  value="<?php echo $Mobilenumber?>"
               class="mt-1 w-full px-4 py-2 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
