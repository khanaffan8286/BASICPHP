...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
  ...
  <div class="bg-white p-8 rounded-2xl shadow-md w-full max-w-md">
    ...
    <form class="space-y-4" action="/MYFIRSTPHP/formvalidation/index.php" id="form" method="POST">
      <div>
      ...
      <div>
        ...
        <div class="relative">
          <input type="Pass" id="Pass" name="Pass1"
      ...
      <div>
        <label for="ConfirmPassword" class="block text-sm font-medium text-gray-700">Confirm Pass</label>
        <div class="relative">
          <input type="Pass" id="ConfirmPassword" name="ConfirmPassword"
            class="mt-1 w-full px-4 py-2 pr-10 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" />
