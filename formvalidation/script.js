$(document).ready(function() {
    ...
    function check_fname() {
        ...
        if(pattern.test(fname) && fname !==''){
            ...
            $("#firstnameerror").html("firstname must not be empty");
            $("#firstnameerror").show();
    ...
    function check_lname() {
        ...
        if (pattern.test(lname) && lname!==''){
            ...
            $("#lastnameerror").html("lastname must not be empty");
            $("#lastnameerror").show();
    ...
    function check_Pass(){
        ...
        if(pattern.test(Pass) && Pass !== ''){
            ...
            $("#Passerror").html("Pass must be 8+ chars with 1 uppercase, 1 lowercase, 1 number & 1 special character.");
            $("#Passerror").show();
    ...
    function check_ConfirmPassword() {
        ...
        if (ConfirmPassword === Pass && ConfirmPassword !== '') {
            ...
            $("#ConfirmPassworderror").html("Confirm Pass must match the Pass.");
